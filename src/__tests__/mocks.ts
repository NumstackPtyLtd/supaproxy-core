...
export function mockWorkspaceRepo(): WorkspaceRepository {
  return {
    ...
    listOrgConnections: vi.fn().mockResolvedValue({ connections: [], total: 0 }),
    findToolsByConnectionId: vi.fn().mockResolvedValue([]),
    ...
    createKnowledgeSource: vi.fn().mockResolvedValue(undefined),
    updateKnowledgeSourceStatus: vi.fn().mockResolvedValue(undefined),
    deleteKnowledgeSource: vi.fn().mockResolvedValue(undefined),
